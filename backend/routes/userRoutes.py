...
from controllers.userController import get_users, get_user, create_user, update_user, delete_user, get_departments, create_department, import_users_excel
...
userBlueprint.route('', methods=['POST'])(role_required(['approver', 'admin'])(create_user))
userBlueprint.route('/import', methods=['POST'])(role_required(['approver', 'admin'])(import_users_excel))
...
userBlueprint.route('/departments', methods=['POST'])(role_required(['approver', 'admin'])(create_department))