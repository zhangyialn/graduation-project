...
from controllers.tripController import get_trips, get_trip, create_trip, end_trip, get_trip_expense, update_trip_expense, get_fuel_prices, create_fuel_prices_batch, get_trip_management_list, pickup_passenger, submit_driver_trip_report, rate_trip, get_my_trips, get_external_oil_prices
